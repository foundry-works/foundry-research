...
Sample outputs from the deep research pipeline, included so you can see what a finished report looks like before running your own session.

## The Uncanny Valley

[Report](uncanny-valley.md)
...
## LLM Confidence in Binary Classification

[Report](llm-confidence.md)
