...
13. **Synthesis — writer → reviewer → verifier flow.** You are the supervisor. Do NOT write the report yourself. Instead, orchestrate the three synthesis agents:
    ...
    **a. Hand off to synthesis-writer.** Spawn a `synthesis-writer` subagent with:
    ...
    - Audit stats (from step 11) for the Methodology section
...
**Source acquisition** (steps 4 and 12 in the workflow). **Always launch as foreground agents.**
